...
namespace Nop.Web.Framework.Models
{
    ...
    public partial class BaseNopModel
    {
        ...
        {
            get { return _customerService.IsVendor(_workContext.CurrentCustomer); }
        }
        public bool IsFoundation
        {
            get { return _customerService.IsFoundation(_workContext.CurrentCustomer); }
        }
        public bool IsTranslator
        {
            get { return _customerService.IsTranslator(_workContext.CurrentCustomer); }
        }
        public bool IsAdmin
        {
            get { return _customerService.IsAdmin(_workContext.CurrentCustomer); }
        }
        #endregion
