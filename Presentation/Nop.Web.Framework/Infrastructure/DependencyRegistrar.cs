...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            //services
            builder.RegisterType<VendorRatingService>().As<IVendorRatingService>().InstancePerLifetimeScope();
            builder.RegisterType<VendorFollowerService>().As<IVendorFollowerService>().InstancePerLifetimeScope();
            builder.RegisterType<DeviceInfoService>().As<IDeviceInfoService>().InstancePerLifetimeScope();
            builder.RegisterType<ConstantService>().As<IConstantService>().InstancePerLifetimeScope();

            builder.RegisterType<BackInStockSubscriptionService>().As<IBackInStockSubscriptionService>().InstancePerLifetimeScope();
            builder.RegisterType<CategoryService>().As<ICategoryService>().InstancePerLifetimeScope();
            builder.RegisterType<CatalogSettings>().As<ISettings>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<BlackPointService>().As<IBlackPointService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<Nop.Services.Notifications.NotificationService>().As<Nop.Services.Notifications.INotificationService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<PushNotificationTemplateService>().As<IPushNotificationTemplateService>().InstancePerLifetimeScope();
            builder.RegisterType<BizTalkEMailClient>().As<IEmailClient>().InstancePerLifetimeScope();
            //NEWLY ADDED
            // builder.RegisterType<NotificationService>().As<INotificationService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<CustomerTranslatorService>().As<ICustomerTranslatorService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<FoundationService>().As<IFoundationService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<TradelicenseService>().As<ITradelicenseService>().InstancePerLifetimeScope();
