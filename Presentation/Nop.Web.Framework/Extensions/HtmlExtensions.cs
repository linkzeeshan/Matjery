...
namespace Nop.Web.Framework.Extensions
{
    ...
    public static class HtmlExtensions
    {
        ...
        /// <returns>Name</returns>
        public static string GetSelectedTabName(this IHtmlHelper helper, string dataKeyPrefix = null, string selectedTabeName = "")
        {
            //keep this method synchronized with
            //"SaveSelectedTab" method of \Area\Admin\Controllers\BaseAdminController.cs
            //var tabName = string.Empty;
            var tabName = selectedTabeName;
