...
namespace Nop.Web.Framework.Controllers
{
    ...
    public abstract class BaseController : Controller
    {
        ...
        public virtual int GetActiveStoreScopeConfiguration(IStoreService storeService, IWorkContext workContext, IGenericAttributeService genericAttributeService)
        {
            ...
            var storeId = genericAttributeService.GetAttribute<int>(workContext.CurrentCustomer, NopCustomerDefaults.AdminAreaStoreScopeConfigurationAttribute);
