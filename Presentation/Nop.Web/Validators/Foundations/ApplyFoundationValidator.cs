...
{
    public partial class ApplyFoundationValidator : BaseNopValidator<ApplyFoundationModel>
    {
        public ApplyFoundationValidator(ILocalizationService localizationService)
        {
