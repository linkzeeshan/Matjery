    ...
    public partial class AffiliateController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(AffiliateModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //var notificationmessag = $"{_localizationService.GetLocalized(affiliate, x => x.FriendlyUrlName, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Affiliates.Added")}";
