    ...
    public partial class CustomerAttributeController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(CustomerAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{_localizationService.GetLocalized(customerAttribute, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Customers.CustomerAttributes.Added")}";
        ...
        public virtual IActionResult Edit(CustomerAttributeModel model, bool continueEditing)
        {
            ...
            var notificationmessag = $"{_localizationService.GetLocalized(customerAttribute, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Customers.CustomerAttributes.Updated")}";
            _notificationService.SuccessNotification(notificationmessag);
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            _customerActivityService.InsertActivity("DeleteCustomerAttribute",
                ...
                customerAttribute);
            var notificationmessag = $"{_localizationService.GetLocalized(customerAttribute, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Customers.CustomerAttributes.Deleted")}";
            _notificationService.SuccessNotification(notificationmessag);
            return RedirectToAction("List");
        }
