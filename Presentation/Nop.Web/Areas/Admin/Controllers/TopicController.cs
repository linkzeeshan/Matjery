    ...
    public partial class TopicController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(TopicModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{_localizationService.GetLocalized(topic, x => x.Title, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.ContentManagement.Topics.Added")}";
        ...
        public virtual IActionResult Edit(TopicModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{_localizationService.GetLocalized(topic, x => x.Title, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.ContentManagement.Topics.Updated")}";
                _notificationService.SuccessNotification(notificationmessag);
