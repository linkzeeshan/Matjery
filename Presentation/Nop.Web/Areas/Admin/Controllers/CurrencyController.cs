    ...
    public partial class CurrencyController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(CurrencyModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{_localizationService.GetLocalized(currency, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Configuration.Currencies.Added")}";
        ...
        public virtual IActionResult Edit(CurrencyModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{_localizationService.GetLocalized(currency, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Configuration.Currencies.Updated")}";
                _notificationService.SuccessNotification(notificationmessag);
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            try
            {
                ...
                var notificationmessag = $"{_localizationService.GetLocalized(currency, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Configuration.Currencies.Deleted")}";
                _notificationService.SuccessNotification(notificationmessag);
