    ...
    public partial class CountryController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(CountryModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{_localizationService.GetLocalized(country, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Configuration.Countries.Added")}";
        ...
        public virtual IActionResult Edit(CountryModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //stores
                SaveStoreMappings(country, model);
                var notificationmessag = $"{_localizationService.GetLocalized(country, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Configuration.Countries.Updated")}";
                _notificationService.SuccessNotification(notificationmessag);
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            try
            {
                ...
                var notificationmessag = $"{_localizationService.GetLocalized(country, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Configuration.Countries.Deleted")}";
                _notificationService.SuccessNotification(notificationmessag);
        ...
        public virtual IActionResult GetStatesByCountryId(string countryId, bool? addSelectStateItem, bool? addAsterisk)
        {
            ...
            var result = (from s in states
                          select new { id = s.Id, name = _localizationService.GetLocalized(s, k => k.Name) }).ToList();
