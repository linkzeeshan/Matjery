    ...
    public partial class ManufacturerController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(ManufacturerModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{_localizationService.GetLocalized(manufacturer, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Catalog.Manufacturers.Added")}";
        ...
        public virtual IActionResult Edit(ManufacturerModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{_localizationService.GetLocalized(manufacturer, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Catalog.Manufacturers.Updated")}";
                _notificationService.SuccessNotification(notificationmessag);
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            var notificationmessag = $"{_localizationService.GetLocalized(manufacturer, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Catalog.Manufacturers.Deleted")}";
            _notificationService.SuccessNotification(notificationmessag);
