    ...
    public partial class AddressAttributeController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(AddressAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{_localizationService.GetLocalized(addressAttribute, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Address.AddressAttributes.Added")}";
        ...
        public virtual IActionResult Edit(AddressAttributeModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //locales
                UpdateAttributeLocales(addressAttribute, model);
                var notificationmessag = $"{_localizationService.GetLocalized(addressAttribute, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Address.AddressAttributes.Updated")}";
                _notificationService.SuccessNotification(notificationmessag);
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            _customerActivityService.InsertActivity("DeleteAddressAttribute",
                ...
                addressAttribute);
            var notificationmessag = $"{_localizationService.GetLocalized(addressAttribute, x => x.Name, _workContext.WorkingLanguage.Id)} {_localizationService.GetResource("Admin.Address.AddressAttributes.Deleted")}";
            _notificationService.SuccessNotification(notificationmessag);
