    ...
    public partial class LanguageController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(LanguageModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{language.Name} {_localizationService.GetResource("Admin.Configuration.Languages.Added")}";
        ...
        public virtual IActionResult Edit(LanguageModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //notification
                var notificationmessag = $"{language.Name} {_localizationService.GetResource("Admin.Configuration.Languages.Updated")}";
                _notificationService.SuccessNotification(notificationmessag);
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            var notificationmessag = $"{language.Name} {_localizationService.GetResource("Admin.Configuration.Languages.Deleted")}";
            _notificationService.SuccessNotification(notificationmessag);
