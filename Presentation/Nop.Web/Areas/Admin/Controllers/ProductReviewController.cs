    ...
    public partial class ProductReviewController : BaseAdminController
    {
        ...
        public virtual IActionResult Edit(ProductReviewModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{productReview.Title} {_localizationService.GetResource("Admin.Catalog.ProductReviews.Updated")}";
                _notificationService.SuccessNotification(notificationmessag, name: _localizationService.GetResource("admin.catalog.productreviews.editproductreviewdetails"));
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            var notificationmessag = $"{productReview.Title} {_localizationService.GetResource("Admin.Catalog.ProductReviews.Deleted")}";
            _notificationService.SuccessNotification(notificationmessag, name: _localizationService.GetResource("admin.catalog.productreviews.editproductreviewdetails"));
