    ...
    public partial class EmailAccountController : BaseAdminController
    {
        ...
        public virtual IActionResult Create(EmailAccountModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{emailAccount.Email} {_localizationService.GetResource("Admin.Configuration.EmailAccounts.Added")}";
        ...
        public virtual IActionResult Edit(EmailAccountModel model, bool continueEditing)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var notificationmessag = $"{emailAccount.Email} {_localizationService.GetResource("Admin.Configuration.EmailAccounts.Updated")}";
                _notificationService.SuccessNotification(notificationmessag);
        ...
        public virtual IActionResult ChangePassword(EmailAccountModel model)
        {
            ...
            var notificationmessag = $"{emailAccount.Email} {_localizationService.GetResource("Admin.Configuration.EmailAccounts.Fields.Password.PasswordChanged")}";
            _notificationService.SuccessNotification(notificationmessag);
        ...
        public virtual IActionResult SendTestEmail(EmailAccountModel model)
        {
            ...
            try
            {
                ...
                var notificationmessag = $"{emailAccount.Email} {_localizationService.GetResource("Admin.Configuration.EmailAccounts.SendTestEmail.Success")}";
                _notificationService.SuccessNotification(notificationmessag);
            }
            catch (Exception exc)
            {
        ...
        public virtual IActionResult Delete(int id)
        {
            ...
            try
            {
                ...
                var notificationmessag = $"{emailAccount.Email} {_localizationService.GetResource("Admin.Configuration.EmailAccounts.Deleted")}";
                _notificationService.SuccessNotification(notificationmessag);
