...
namespace Nop.Web.Areas.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
    {
        ...
        public virtual IActionResult GeneralCommon(GeneralCommonSettingsModel model)
        {
            ...
            storeInformationSettings.AppVersion = model.StoreInformationSettings.AppVersion;
            ...
            //this behavior can increase performance because cached settings will not be cleared 
            //and loaded from database after each update
            _settingService.SaveSettingOverridablePerStore(storeInformationSettings, x => x.AppVersion, model.StoreInformationSettings.AppVersion_OverrideForStore, storeScope, false);
