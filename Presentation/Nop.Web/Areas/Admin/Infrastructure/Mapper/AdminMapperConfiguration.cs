...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        protected virtual void CreateCatalogMaps()
        {
            ...
            CreateMap<BulkEditProductModel, Product>();
        }
        ...
        protected virtual void CreateCustomersMaps()
        {
            ...
            CreateMap<BlackPoint, BlackPointModel>()
              .ForMember(m => m.PointStatusId, opt => opt.MapFrom(src => src.BlackPointStatus))
              .ForMember(m => m.CreatedOn, opt => opt.MapFrom(src => src.CreatedOnUtc));
              
            //CreatedOn=point.CreatedOnUtc
            CreateMap<BlackPointModel, BlackPoint>();

            CreateMap<FoundationModel, Foundation>();
            CreateMap<Foundation, FoundationModel>();
        ...
        protected virtual void CreateMessagesMaps()
        {
            ...
            //CreateMap<CampaignProductModel, ProductCampaign>();
            CreateMap<ProductCampaign, CampaignProductModel>();
        ...
        protected virtual void CreateVendorsMaps()
        {
                ...
                CreateMap<AdminVendorReviewModel, VendorReview>();
            CreateMap<VendorReview, AdminVendorReviewModel>();
            //follower
            CreateMap<VendorFollowerModel, VendorFollower>();
            //.ForMember(dest => dest.LimitedToStores, mo => mo.Ignore())

            CreateMap<VendorFollower, VendorFollowerModel>()
                .ForMember(dest => dest.VendorName, mo => mo.MapFrom(v => v.Vendor.Name))
                .ForMember(dest => dest.CustomerName, mo => mo.MapFrom(c => EngineContext.Current.Resolve<ICustomerService>().GetCustomerFullName(c.Customer))) //get fullname
