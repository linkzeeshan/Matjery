    ...
    public partial class VendorModelFactory : IVendorModelFactory
    {
        ...
        protected virtual void PrepareAssociatedCustomerModels(IList<VendorAssociatedCustomerModel> models, Vendor vendor)
        {
            ...
            foreach (var customer in associatedCustomers)
            {
                ...
                {
                    Id = customer.Id,
                    Email = string.IsNullOrEmpty(customer.Email) ? customer.Username : customer.Email
                });
            }
        }
        ...
        public virtual VendorSearchModel PrepareVendorSearchModel(VendorSearchModel searchModel)
        {
            ...
            var vendors = _vendorService.GetAllEntities(VendorRegisterationType.Foundation, 0, int.MaxValue);
            if (vendors.Any())
            {
                searchModel.SupportedByFoundations.Add(new SelectListItem
                {
                    Value = "0",
                ...
                foreach (var vendor in vendors)
                    searchModel.SupportedByFoundations.Add(new SelectListItem
                    {
                        ...
                        Selected = searchModel.sbfid == vendor.Id
                    });
            }
        ...
        public virtual VendorListModel PrepareVendorListModel(VendorSearchModel searchModel)
        {
            ...
            {
                int FoundationID = searchModel.SupportedByFoundationsLabel;
                vendors = _vendorService.GetAllVendorsIncludeSBF(searchModel.SearchName, 

                    "", pageIndex: searchModel.Page - 1, pageSize: searchModel.PageSize,
                    showNotActive: true, showSupportedVendors: true, languageid: _workContext.WorkingLanguage.Id, supportedByFoundationId: FoundationID,
                    OrderBy: orderBy, sbfid: searchModel.sbfid);
            }
            else
            {
                vendors = _vendorService.GetAllVendors(searchModel.SearchName, "",
                    showSupportedVendors: true, 
                    supportedByFoundationId: _workContext.CurrentCustomer.VendorId,
            ...
            //    email: searchModel.SupportedByFoundationsLabel,
            //    pageIndex: searchModel.Page - 1, pageSize: searchModel.PageSize);
            ...
            var model = new VendorListModel().PrepareToGrid(searchModel, vendors, () =>
            {
                ...
                return vendors.Select(vendor =>
                {
                    ...
                    {
                        vendorModel.AprovalStatus = string.IsNullOrEmpty(_localizationService.GetLocalizedEnum(vendor.FoundationAprovalStatus, _workContext.WorkingLanguage.Id)) ? "" : _localizationService.GetLocalizedEnum(vendor.FoundationAprovalStatus, _workContext.WorkingLanguage.Id);
                    }
                    else
                    {
                        vendorModel.AprovalStatus = "";
                    }

                    vendorModel.SeName = _urlRecordService.GetSeName(vendor, 0, true, false);
                    vendorModel.Name = _localizationService.GetLocalized(vendor, c => c.Name, _workContext.WorkingLanguage.Id);
        ...
        public virtual VendorModel PrepareVendorModel(VendorModel model, Vendor vendor, bool excludeProperties = false)
        {
            ...
            if (vendor != null)
            {
                ...
                localizedModelConfiguration = (locale, languageId) =>
                {
                    ...
                    locale.LicensedBy = _localizationService.GetLocalized(vendor,x => x.LicensedBy, languageId, false, false);
            ...
            model.VendorProductSearchModel.SearchVendorId = model.Id;
