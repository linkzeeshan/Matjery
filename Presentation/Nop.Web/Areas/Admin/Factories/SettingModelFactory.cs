    ...
    public partial class SettingModelFactory : ISettingModelFactory
    {
        ...
        protected virtual StoreInformationSettingsModel PrepareStoreInformationSettingsModel()
        {
            ...
            var model = new StoreInformationSettingsModel
            {
                ...
                AppVersion = storeInformationSettings.AppVersion
            };
            ...
            model.AppVersion_OverrideForStore = _settingService.SettingExists(storeInformationSettings, x => x.AppVersion, storeId);
        ...
        protected virtual SeoSettingsModel PrepareSeoSettingsModel()
        {
            ...
            var model = new SeoSettingsModel
            {
                ...
                PageTitleSeoAdjustmentValues = seoSettings.PageTitleSeoAdjustment.ToSelectListInServices(),
                ...
                WwwRequirementValues = seoSettings.WwwRequirement.ToSelectListInServices(),
        ...
        protected virtual CaptchaSettingsModel PrepareCaptchaSettingsModel()
        {
            ...
            model.CaptchaTypeValues = captchaSettings.CaptchaType.ToSelectListInServices();
        ...
        protected virtual FullTextSettingsModel PrepareFullTextSettingsModel()
        {
            ...
            model.SearchModeValues = commonSettings.FullTextMode.ToSelectListInServices();
        ...
        public virtual ForumSettingsModel PrepareForumSettingsModel()
        {
            ...
            //fill in additional values (not existing in the entity)
            model.ActiveStoreScopeConfiguration = storeId;
            model.ForumEditorValues = forumSettings.ForumEditor.ToSelectListInServices();
        ...
        public virtual TaxSettingsModel PrepareTaxSettingsModel()
        {
            ...
            model.TaxBasedOnValues = taxSettings.TaxBasedOn.ToSelectListInServices();
            model.TaxDisplayTypeValues = taxSettings.TaxDisplayType.ToSelectListInServices();
        ...
        public virtual OrderSettingsModel PrepareOrderSettingsModel()
        {
            ...
            model.GiftCards_Activated_OrderStatuses = OrderStatus.Pending.ToSelectListInServices(false).ToList();
            model.GiftCards_Activated_OrderStatuses.Insert(0, new SelectListItem { Text = "---", Value = "0" });
            model.GiftCards_Deactivated_OrderStatuses = OrderStatus.Pending.ToSelectListInServices(false).ToList();
