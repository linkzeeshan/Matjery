...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface ICustomerModelFactory
    {
        ...
        CustomerListModel PrepareDeletedCustomerListModel(CustomerSearchModel searchModel);
        ...
        CustomerModel PrepareCustomerModel(CustomerModel model, Customer customer, bool excludeProperties = false,bool showCountry=false);
        ...
        /// Prepare paged customer order list model
        /// </summary>
        /// <param name="customerId">Customer order search model</param>
        /// <param name="customer">Customer</param>
        /// <returns>Customer order list model</returns>
        List<Order> PrepareCustomerOrderListModel(int customerId, Customer customer);
