...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial interface IProductModelFactory
    {
        ...
        /// <summary>
        /// Prepare Delete product search model
        /// </summary>
        /// <param name="searchModel"></param>
        /// <returns></returns>
        ProductListModel PrepareDeleteProductListModel(ProductSearchModel searchModel);
        ...
        /// <returns>Product model</returns>
        BulkEditSearchModel PrepareBulkEditProductModel(BulkEditSearchModel model);
        BulkEditListModel PrepareBulkEditSelectProductModel(BulkEditSearchModel model);
        List<BulkEditProductModel> PrepareBulkEditPProductModel(BulkEditSearchModel model);
