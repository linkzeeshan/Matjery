...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class CampaignModelFactory : ICampaignModelFactory
    {
        ...
        public virtual CampaignListModel PrepareCampaignListModel(CampaignSearchModel searchModel)
        {
            ...
            var model = new CampaignListModel().PrepareToGrid(searchModel, campaigns, () =>
            {
                return campaigns.Select(campaign =>
                {
                    ...
                    campaignModel.Name = _localizationService.GetLocalized(campaign, x => x.Name);
                    campaignModel.Subject = _localizationService.GetLocalized(campaign, x => x.Subject);
        ...
        public virtual IList<SelectListItem> PrepareCategories(IList<SelectListItem> availableCategoryItems)
        {
            _baseAdminModelFactory.PrepareCategories(availableCategoryItems);
            return availableCategoryItems;
        }
