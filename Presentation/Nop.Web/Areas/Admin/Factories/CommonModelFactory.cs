...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual CommonStatisticsModel PrepareCommonStatisticsModel()
        {
            ...
            {
                NumberOfOrders = _orderService.SearchOrders(vendorId: currentVendorId, pageIndex: 0, pageSize: 1, getOnlyTotalCount: true).TotalCount
            };
            ...
            model.NumberOfLowStockProducts =
                _productService.GetLowStockProducts(vendorId:currentVendorId,getOnlyTotalCount: true).TotalCount +
                _productService.GetLowStockProductCombinations(vendorId: currentVendorId, getOnlyTotalCount: true).TotalCount;
