        ...
        public virtual CountryListModel PrepareCountryListModel(CountrySearchModel searchModel)
        {
            ...
            var model = new CountryListModel().PrepareToGrid(searchModel, countries, () =>
            {
                ...
                return countries.Select(country =>
                {
                    ...
                    countryModel.Name = _localizationService.GetLocalized(country, x => x.Name);
                    countryModel.TwoLetterIsoCode = _localizationService.GetLocalized(country, x => x.TwoLetterIsoCode);
                    countryModel.ThreeLetterIsoCode = _localizationService.GetLocalized(country, x => x.ThreeLetterIsoCode);
