...
namespace Nop.Web.Infrastructure.Cache
{
    public static partial class NopModelCacheDefaults
    {
        ...
        public static CacheKey SEARCH_CATEGORIES_MODEL_KEY => new CacheKey("Nop.pres.search.categories-{0}-{1}-{2}", CategoryHomepagePrefixCacheKey);
        public static string SEARCH_CATEGORIES_PATTERN_KEY => "Nop.pres.search.categories";
        /// <summary>
        ...
        // HOMEPAGE_RECENTLYADDED_IDS_PATTERN_KEY

        public static CacheKey HomePageRecentlyAddedIdsKey => new CacheKey("Nop.pres.recentlyadded.homepage-{0}}", HomePageRecentlyAddedIdsPrefixCacheKey);
        public static string HomePageRecentlyAddedIdsPrefixCacheKey => "Nop.pres.recentlyadded.homepage";

        //CAMPAIGN_HOMEPAGE_KEY 
        public static CacheKey CampaignHomePageKey => new CacheKey("Nop.pres.campaign.homepage-{0}-{1}-{2}-{3}", CampaignHomePageKeyPrefixCachekey);
        public static string CampaignHomePageKeyPrefixCachekey => "Nop.pres.campaign.homepage";

        //CAMPAIGN_PICTURE_MODEL_KEY
        public static CacheKey CampaignPictureModelKey => new CacheKey("Nop.pres.campaign.picture-{0}-{1}-{2}-{3}-{4}", CampaignPictureModelKeyPrefixCachekey);
        public static string CampaignPictureModelKeyPrefixCachekey => "Nop.pres.campaign.picture";
