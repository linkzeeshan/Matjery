...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<PluginUpdatedEvent>
    {
        ...
        public void HandleEvent(EntityUpdatedEvent<Setting> eventMessage)
        {
            ...
            _staticCacheManager.RemoveByPrefix(NopModelCacheDefaults.HomePageRecentlyAddedIdsPrefixCacheKey); //depends on CatalogSettings.NumberOfBestsellersOnHomepage
        ...
        public void HandleEvent(EntityUpdatedEvent<Product> eventMessage)
        {
            ...
            _staticCacheManager.RemoveByPrefix(NopModelCacheDefaults.SitemapPrefixCacheKey);
            _staticCacheManager.RemoveByPrefix(NopModelCacheDefaults.HomePageRecentlyAddedIdsPrefixCacheKey);
        ...
        public void HandleEvent(EntityInsertedEvent<Picture> eventMessage)
        {
            ...
            _staticCacheManager.RemoveByPrefix(NopModelCacheDefaults.CampaignPictureModelKeyPrefixCachekey);
            _staticCacheManager.RemoveByPrefix(NopModelCacheDefaults.CampaignHomePageKeyPrefixCachekey);
