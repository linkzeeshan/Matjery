...
namespace Nop.Web.Infrastructure
{
    ...
    public partial class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
        {
            ...
            //uae pass
            endpointRouteBuilder.MapControllerRoute("UaePassLinking",
                            $"{pattern}uaepasslinking",
                            new { controller = "Customer", action = "CustomerLinking" });

            //uae pass logout
            endpointRouteBuilder.MapControllerRoute("",
                            $"{pattern}uaepasslogout",
                            new { controller = "Customer", action = "UaePassLogout" });

            //uae pass logout
            endpointRouteBuilder.MapControllerRoute("logoutfromuaepass",
                            $"{pattern}logoutfromuaepass",
                            new { controller = "Customer", action = "LogOutFromUaePass" });

            //uae pass
            endpointRouteBuilder.MapControllerRoute("uaepass",
                            $"{pattern}uaepass",
                            new { controller = "Customer", action = "UaePass" });


            //uae pass call back
            endpointRouteBuilder.MapControllerRoute("callback",
                            pattern+"UaePass/callback/{code?}",
                            new { controller = "Customer", action = "UaePassCallBack" });

            //uae pass register
            endpointRouteBuilder.MapControllerRoute("UaePassRegisterationLogOut",
                            $"{pattern}uaepassregisterationlogOut",
                            new
                            {
                                controller = "Customer",
                                action = "UaePassRegisterationLogOut",
                            });
            ...
            //registerInit
            endpointRouteBuilder.MapControllerRoute("RegisterInit",
                            "registerInit/",
                            new { controller = "Customer", action = "RegisterInit" });
            //logout
            ...
            endpointRouteBuilder.MapControllerRoute("CustomerBulkProductReviews",
                 "Customer/CustomerBulkProductReview",
                 new { controller = "Customer", action = "CustomerBulkProductReview" });
            ...
            endpointRouteBuilder.MapControllerRoute("ProductSearchNew",
                          "catalog/advancedsearch",
                          new { controller = "Catalog", action = "SearchNew" });

            endpointRouteBuilder.MapControllerRoute("ProductSearchAutoComplete", $"{pattern}catalog/searchtermautocomplete",
                new { controller = "Catalog", action = "SearchTermAutoComplete" });

            //vendor search
            endpointRouteBuilder.MapControllerRoute("VendorSearchAutoComplete",
                            "catalog/vendorsearchtermautocomplete",
                            new { controller = "Catalog", action = "VendorSearchTermAutoComplete" });
            ...
            endpointRouteBuilder.MapControllerRoute("RemoveFromWishlist",
                    "RemoveFromWishlist/{productId}",
                    new { controller = "ShoppingCart", action = "RemoveFromWishlist" },
            ...
            endpointRouteBuilder.MapControllerRoute("FollowVendor", pattern + "catalog/FollowVendor",
              new { controller = "catalog", action = "FollowVendor" });

            endpointRouteBuilder.MapControllerRoute("VendorReviews", pattern + "VendorReviewPublic/VendorReviewsAdd",
          new { controller = "VendorReviewPublic", action = "VendorReviewsAdd" });
            ...
            endpointRouteBuilder.MapControllerRoute("FollowedVendors",
                         "customer/FollowedVendors",
                         new { controller = "Customer", action = "FollowedVendors" });
            endpointRouteBuilder.MapControllerRoute("VendorProducts",
                        "Product/VendorProducts",
                        new { controller = "Product", action = "VendorProducts" });

            //contact vendor
            endpointRouteBuilder.MapControllerRoute("BlackPoint",
                            "BlackPoint/{OrderId}",
                            new { controller = "BlackPoint", action = "Index" });

            //apply for vendor account
            endpointRouteBuilder.MapControllerRoute("ApplyFoundation",
                            "foundation/applyfoundation",
                            new { controller = "Foundation", action = "ApplyFoundation" });

            //endpointRouteBuilder.MapControllerRoute("AddVendorReview",
            //      "VendorReviewPublic/VendorReviewsAdd",
            //      new { controller = "VendorReviewPublic", action = "VendorReviewsAdd" }, 
            //      new[] { "Nop.Web.Controllers" });
            ...
            endpointRouteBuilder.MapControllerRoute("Tradelicenseinfo", $"{pattern}customer/LicenseInfo",
           new { controller = "Vendor", action = "LicenseInfo" });
