...
namespace Nop.Web.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            //IPushNotificationTemplateService
            ...
            builder.RegisterType<BlackPointModelFactory>().As<IBlackPointModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<FoundationModelFactory>().As<IFoundationModelFactory>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<PushNotificationTemplateModelFactory>().As<IPushNotificationTemplateModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<NotificationModelFactory>().As<INotificationModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<QueuedQueuedPushNotificationModelFactory>().As<IQueuedQueuedPushNotificationModelFactory>().InstancePerLifetimeScope();
            builder.RegisterType<SmsPluginModelFactory>().As<ISmsPluginModelFactory>().InstancePerLifetimeScope();
            //factories
