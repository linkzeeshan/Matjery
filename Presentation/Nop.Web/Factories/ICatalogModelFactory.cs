...
namespace Nop.Web.Factories
{
    public partial interface ICatalogModelFactory
    {
        ...
        VendorListModel PrepareVendorAllModels(CatalogPagingFilteringModel command, bool displayEntities = false);
        List<VendorModel> PrepareVendor(bool? displayEntities = false,int Pagesize=10);
        ...
        SearchModel PrepareNewSearchModel(SearchModel model, CatalogPagingFilteringModel command);
