...
namespace Nop.Web.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual AdminHeaderLinksModel PrepareAdminHeaderLinksModel()
        {
            ...
            bool IsActiveVendor = vendor != null ? vendor.Active : false;
            var model = new AdminHeaderLinksModel
            {
                ...
                DisplayAdminLink = _customerService.IsAdmin(customer)? _permissionService.Authorize(StandardPermissionProvider.AccessAdminPanel): IsActiveVendor&& _permissionService.Authorize(StandardPermissionProvider.AccessAdminPanel),
