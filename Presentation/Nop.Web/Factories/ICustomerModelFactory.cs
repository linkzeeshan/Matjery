...
namespace Nop.Web.Factories
{
    ...
    public partial interface ICustomerModelFactory
    {
        ...
        /// <summary>
        /// Prepare the customer delete model
        /// </summary>
        /// <param name="model">Customer info model</param>
        /// <param name="customer">Customer</param>
        /// <returns>Customer info model</returns>
        DeleteCustomerAccountModel PrepareDeleteCustomerAccountModel(DeleteCustomerAccountModel model, Customer customer);
        ...
        ///<summary>
        ///Prepare the BulkProdutReviewModel
        /// </summary>
        bool AddCustomerBulkProductReview(List<CustomerProductReviewModelRequest> model);

        List<CustomerProductReviewModel> GetProductsForReviews();
    }
}
