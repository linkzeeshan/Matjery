...
namespace Nop.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        public virtual IActionResult BillingAddress(IFormCollection form)
        {
            ...
            model.ExistingAddresses=model.ExistingAddresses.OrderByDescending(x => x.IsDefault).ToList();
        ...
        public virtual IActionResult ConfirmOrder()
        {
            ...
            try
            {
                ...
                if (placeOrderResult.Success)
                {
                    ...
                    foreach (var placeOrder in placeOrderResult.PlaceOrders)
                    {
                        placeOrderResult.PlacedOrder = placeOrder;
