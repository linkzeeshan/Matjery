    ...
    public partial class ProductController : BasePublicController
    {
        ...
        public virtual IActionResult ProductReviews(int productId)
        {
            ...
            if (!_customerService.IsGuest(_workContext.CurrentCustomer))
            {
                ...
                if (totalCustomerOrders > 0)
                {
                    ...
                    int totalCustomerReviews = userReviews.TotalCount;// product.ProductReviews.Count(c => c.CustomerId == _workContext.CurrentCustomer.Id);
                    if (totalCustomerOrders > totalCustomerReviews)
                        model.AddProductReview.CanCurrentCustomerLeaveReview = true;

                }
                if (!model.AddProductReview.CanCurrentCustomerLeaveReview)
                    ModelState.AddModelError("", _localizationService.GetResource("reviews.onlycustomerwhopurchasedcanreview"));
            }
        ...
        public virtual IActionResult ProductReviewsAdd(int productId, ProductReviewsModel model, bool captchaValid)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ViewBag.productReviewStatus = true;
                model.AddProductReviewStatus = true;
                CustomerProductReviewsModel customerProductReviewsModel = new CustomerProductReviewsModel { AddProductReviewStatus = true };
        ...
        #region My account / Product
        // [NopHttpsRequirement(SslRequirement.Yes)]
        public ActionResult VendorProducts(int? productThumbPictureSize)
        {
            if (_workContext.CurrentVendor == null)
                return RedirectToRoute("HomePage");

            var products = _productService.GetProductsByVendorId(_workContext.CurrentVendor.Id);
        ...
        //{
        //    return _productModelFactory.PrepareProductOverviewModels(_workContext,
        //        _storeContext, _categoryService, _productService, _specificationAttributeService,
        //        _priceCalculationService, _priceFormatter, _permissionService,
        //        _localizationService, _taxService, _currencyService,
        //        _pictureService, _measureService, _webHelper, _staticCacheManager,
       ...
       // [ChildActionOnly]
        ...
        // [ChildActionOnly]
        public ActionResult HomepageDiscountedProducts(int? productThumbPictureSize)
        {
