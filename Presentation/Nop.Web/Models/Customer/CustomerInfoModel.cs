...
namespace Nop.Web.Models.Customer
{
    public partial class CustomerInfoModel : BaseNopModel
    {
        public CustomerInfoModel()
        {
            ...
            DeleteCustomerAccountModel = new DeleteCustomerAccountModel();
        }
        ...
        [NopResourceDisplayName("Account.Fields.Area")]
        ...
        public bool customerInfoStatus { get; set; } = false;
        ...
        [NopResourceDisplayName("Account.Fields.CountryNationality")]
        public int CountryNationalityId { get; set; }
        public IList<SelectListItem> AvailableNationalities { get; set; }
        public DeleteCustomerAccountModel DeleteCustomerAccountModel { get; set; }
        ...
        public IList<CustomerProductReviewModel> customerProductReviewModels { get; set; }
