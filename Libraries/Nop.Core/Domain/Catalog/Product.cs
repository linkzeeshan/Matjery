...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported, IDiscountSupported<DiscountProductMapping>
    {
        ...
        private ICollection<ProductCampaign> _productCampaigns;
        ...
        /// Gets or sets the collection of ProductCategory
        /// </summary>
        public virtual ICollection<ProductCampaign> ProductCampaigns
        {
            get { return _productCampaigns ?? (_productCampaigns = new List<ProductCampaign>()); }
            protected set { _productCampaigns = value; }
        }
