namespace Nop.Core.Domain.Messages
{
    ...
    public static partial class MessageTemplateSystemNames
    {
        ...
        /// <summary>
        /// Represents system name of customer delete account request message
        /// </summary>
        public const string CustomerDeleteAccountMessage = "Customer.DeleteAccountNotification";

        public const string CustomerAccountDeletedMessage = "Admin.Customer.DeleteRequest.Approved";

        public const string VendorAccountDeletedMessage = "Admin.Vendor.DeleteRequest.Approved";
        
        /// <summary>
        /// Represents system name of customer delete account request message
        /// </summary>
        public const string VendorDeleteAccountMessage = "Vendor.DeleteAccountNotification";
        /// <summary>
        /// Represents system name of customer delete account request message
        /// </summary>
        public const string CustomerDeleteAccountRequestToAdminMessage = "Customer.CustomerDeleteAccountRequestToAdmin";

        /// <summary>
        /// Represents system name of customer delete account request message
        /// </summary>
        public const string VendorDeleteAccountRequestToAdminMessage = "Vendor.CustomerDeleteAccountRequestToAdmin";
        #endregion
        ...
        public const string OrderProcessedCustomerNotification = "OrderProcessed.CustomerNotification";
        /// <summary>
