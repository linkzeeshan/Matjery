...
namespace Nop.Core.Domain.Common
{
    ...
    public class CommonSettings : ISettings
    {
        ...
        //CUSTMOZIED FILEDS
        /// <summary>
        /// Gets or sets a value of "DefaultStoreLogo"
        /// </summary>
        public string DefaultStoreLogo { get; set; }
        /// <summary>
        /// 
        /// </summary>
        public string UaePassClientId { get; set; }
        /// <summary>
        /// 
        /// </summary>
        public string UaePassSecretKey { get; set; }
        /// <summary>
        /// 
        /// </summary>
        public string UaePassCallBackUrl { get; set; }
        /// <summary>
        /// 
        /// </summary>
        public string UaePassAuthorizationEndPoint { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public string UaePassTokenEndPoint { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public string UaePassUserInfoEndPoint { get; set; }

        /// <summary>
        /// 
        /// </summary>
        public string UaePassUserInfoLogout { get; set; }
        /// <summary>
        /// 
        /// </summary>
        public string UaePass_Mode { get; set; }
        public string LocalAppUrl { get; set; }
        /// <summary>
        /// to send email based on this config
        /// </summary>
        public bool IsBiztalkServer { get; set; }

        public string Autotranslation_key { get; set; }
        public string Autotranslation_endpoint { get; set; }
        public string Autotranslation_location { get; set; }
        public string Autotranslation_route { get; set; }
        public int ResendTokenTimer { get; set; }
        public string AdminEmail { get; set; }
        public int LicenseExpiryReminder1Days { get; set; }
        public int LicenseExpiryReminder2Days { get; set; }
        public int LicenseExpiryReminder3Days { get; set; }
        public string TradeLicenseApi { get; set; }
        public string ClientId { get; set; }
        public string ClientSecret { get; set; }
        public string MandateCategoryForSellers { get; set; }
    }
}
