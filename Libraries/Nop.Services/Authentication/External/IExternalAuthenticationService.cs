...
namespace Nop.Services.Authentication.External
{
    ...
    public partial interface IExternalAuthenticationService
    {
        ...
        /// <param name="accesTokenKey"></param>
        /// <returns></returns>
        AuthorizationResult AuthorizeUaePass(string uuid, string idn, string oauthAccessToken, string oauthToken, string email, string name);

        ExternalAuthenticationRecord GetExternalAuthUser(string ProviderSytem, string Email);
