...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerRegistrationService
    {
        ...
        CustomerLoginResults ValidateCustomer(string usernameOrEmail, string password, bool ignorePasswordHash = false,bool IsExternal=false);
        CustomerLoginResults ValidateCustomerByUUID(int uuid, bool ignorePasswordHash = false);
        ...
        CustomerRegistrationResult ValidateRegister(CustomerRegistrationRequest request);
