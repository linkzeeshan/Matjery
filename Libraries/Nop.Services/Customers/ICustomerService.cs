...
namespace Nop.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        Customer GetCustomerByOldSystemCustomerId(int oldSystemId);
        ...
        //Customer GetCustomerByEmail(string email); //new
        Customer GetCustomerByEmail(string email, bool checkForDelete = false); // old 3.8 method
        ...
        Customer GetCustomerByUsername(string username, bool checkFordelete = false);
        ...
        bool IsFoundation( Customer customer, bool onlyActiveCustomerRoles = true);

        bool IsTranslator( Customer customer, bool onlyActiveCustomerRoles = true);
        /// <summary>
        ...
        /// </summary>
        IPagedList<Customer> Deletedcustomers(int pageIndex = 0, int pageSize = int.MaxValue);
