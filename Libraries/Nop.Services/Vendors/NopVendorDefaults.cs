...
namespace Nop.Services.Vendors
{
    ...
    public static partial class NopVendorDefaults
    {
        ...
        /// <summary>
        /// Gets a generic attribute key to store Trade Issue Date
        /// </summary>
        public static string TradeIssueDate => "TradeIssueDate";

        /// <summary>
        /// Gets a generic attribute key to store Trade Expiry Date
        /// </summary>
        public static string TradeExpiryDate => "TradeExpiryDate";

        /// <summary>
        /// Gets a generic attribute key to store Category
        /// </summary>
        public static string TradeCategory => "TradeCategory";
