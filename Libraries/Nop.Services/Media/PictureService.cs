...
namespace Nop.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        public virtual string GetDefaultPictureUrl(int targetSize = 0,
            PictureType defaultPictureType = PictureType.General,
        ...
        public virtual string GetPictureUrl(int pictureId,
            ...
            string storeLocation = null,
            PictureType defaultPictureType = PictureType.VendorOrEntity)
        {
        ...
        public Picture GetPictureByOldSystemId(int pictureId)
        {
            if (pictureId == 0)
                return null;

            return _pictureRepository.Table.FirstOrDefault(p => p.OldSystemPictureId == pictureId);
        }

        
        public virtual Picture InsertPicture(byte[] pictureBinary, string mimeType, string seoFilename, int OldSystemPictureId,
          string altAttribute = null, string titleAttribute = null,
          bool isNew = true, bool validateBinary = true)
        {
            mimeType = CommonHelper.EnsureNotNull(mimeType);
            ...
            var picture = new Picture
            {
                ...
                TitleAttribute = titleAttribute,
                IsNew = isNew,
                OldSystemPictureId = OldSystemPictureId
            };
            _pictureRepository.Insert(picture);
