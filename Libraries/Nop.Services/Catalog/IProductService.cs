...
namespace Nop.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        IList<Product> GetAllProductsDisplayedOnHomepage(); //COMMENTED AS PER CUSTOMIZATION
        IPagedList<Product> GetAllProductsDisplayedOnHomePage(int pageIndex = 0, int pageSize = int.MaxValue);
        IPagedList<Product> GetAllProductsDiscounted(int pageIndex , int pageSize = int.MaxValue);
        //IList<Product> GetAllProductsDiscounted();
        ...
        Product GetProductByOldSystemId(int productId);
        /// <summary>
        ...
        IList<Product> GetProductsByVendorId(int id);
        IPagedList<Product> GetRecentlyAddedProducts(int pageIndex = 0, int pageSize = int.MaxValue);
        ...
        IPagedList<Product> SearchProductsMod(
          int pageIndex = 0,
          int pageSize = int.MaxValue,
          IList<int> categoryIds = null,
          int manufacturerId = 0,
        ...
        IPagedList<Product> deletedProduct(int pageIndex = 0,int pageSize = int.MaxValue,int vendorid=0);
        /// <summary>
        ...
        /// <summary>
        /// Gets a product by name and vendor ID
        /// </summary>
        /// <param name="name">SKU</param>
        /// <param name="vendorId">Vendpor Id</param>
        /// <returns>Product</returns>
        Product GetProductByName(string name , int vendorId=0);
       ...
       // IPagedList<ProductReview> IsReviewDone(int customerId = 0, int productId = 0,int [] orderIDs=null);
        ...
        /// <param name="pageIndex">Page index</param>
        /// <param name="pageSize">Page size</param>
        /// <param name="top">Get Top 3 products for review by default</param>
        /// <returns>Reviews</returns>
        IPagedList<Product> GetCustomerTopProductOrderItem(int customerId = 0, bool? approved = null,
            DateTime? fromUtc = null, DateTime? toUtc = null,
            int storeId = 0, int productId = 0, int vendorId = 0, bool showHidden = false,
            int pageIndex = 0, int pageSize = int.MaxValue, int top = 3);


        //GetCustomerLastProductOrderItem
        IPagedList<OrderItem> GetCustomerLastProductOrderItem(int customerId = 0, bool? approved = null,
           DateTime? fromUtc = null, DateTime? toUtc = null,
           int storeId = 0, int productId = 0, int vendorId = 0, bool showHidden = false,
           int pageIndex = 0, int pageSize = int.MaxValue, int top = 3);
