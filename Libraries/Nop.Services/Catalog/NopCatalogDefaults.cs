...
namespace Nop.Services.Catalog
{
    ...
    public static partial class NopCatalogDefaults
    {
        ...
        public static CacheKey Homepage_Bestsellers_Ids_Key => new CacheKey("Nop.pres.bestsellers.homepage-{0})");
        ...
        /// {2} : categories ID hash
        /// </remarks>
        public static CacheKey SearchCategoryCacheKey => new CacheKey("Nop.productcategory.numberofproducts-{0}-{1}-{2}", SearchCategoryPrefixCacheKey);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string SearchCategoryPrefixCacheKey => "Nop.productcategory.numberofproducts";
        ...
        /// {2} : category ID
        /// </remarks>
        public static CacheKey CATEGORY_NUMBER_OF_PRODUCTS_MODEL_KEY => new CacheKey("Nop.pres.category.numberofproducts-{0}-{1}-{2}");
        /// <summary>
        ...
        /// {2} : current store ID
        /// </remarks>
        public static CacheKey CATEGORY_CHILD_IDENTIFIERS_MODEL_KEY => new CacheKey("Nop.pres.category.childidentifiers-{0}-{1}-{2}");
        #endregion
        ...
        public static CacheKey PRODUCT_HAS_PRODUCT_ATTRIBUTES_KEY => new CacheKey("Nop.pres.product.hasproductattributes-{0})");
        #endregion
        ...
        /// {2} : categories ID hash
        /// </remarks>
        public static CacheKey TopicModelBySystemCacheKey => new CacheKey("Nop.topic.detailsoftopics-{0}-{1}-{2}", TopicModelBySystemPrefixCacheKey);

        /// <summary>
        /// Gets a key pattern to clear cache
        /// </summary>
        public static string TopicModelBySystemPrefixCacheKey => "Nop.topic.detailsoftopics";
        #endregion
        #endregion
    }
}