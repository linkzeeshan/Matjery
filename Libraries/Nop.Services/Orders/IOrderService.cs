...
namespace Nop.Services.Orders
{
    ...
    public partial interface IOrderService
    {
        ...
        /// Gets list of  order
        /// </summary>
        /// <param name="customerId">The custom Id</param>
        /// <returns>Order</returns>
        List<Order> GetOrderByCustomOrderById(int customerId);
        ...
        IPagedList<Order> SearchOrders(int storeId = 0,
            ...
            string orderNotes = null, int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false, bool deleted = false);/// <summary>
        /// Search orders
        /// </summary>
        /// <param name="storeId">Store identifier; null to load all orders</param>
        /// <param name="vendorId">Vendor identifier; null to load all orders</param>
        ...
        /// <param name="getOnlyTotalCount">A value in indicating whether you want to load only total number of records. Set to "true" if you don't want to load data from database</param>
        /// <returns>Orders</returns>
        IPagedList<Order> SearchOrdersforReview(int storeId = 0,
            int vendorId = 0, int customerId = 0,
            int productId = 0, int affiliateId = 0, int warehouseId = 0,
            int billingCountryId = 0, string paymentMethodSystemName = null,
            DateTime? createdFromUtc = null, DateTime? createdToUtc = null,
        ...
        int OrderCountforproduct(int customerId = 0, int productId = 0);
        ...
        List<Order> GetNotExcutedOrders();
        /// <summary>
        /// Parse tax rates
        /// </summary>
        /// <param name="order">Order</param>
        ...
        IList<OrderItem> GetOrderItems(int orderId, bool? isNotReturnable = null, bool? isShipEnabled = null, int vendorId = 0, int productId = 0);
        ...
        void UpdateOrderItemByProductIdAnCustomerId(int productId, int customerId, int orderId);
        bool IsDisplayed(int productId, int customerId, int orderId);
        #endregion
