...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord ManageProductsBuilkEdit = new PermissionRecord { Name = "Admin area. Manage Products Bulk Edit", SystemName = "ManageProductsBuilkEdit", Category = "Catalog" };
        ...
        public static readonly PermissionRecord ManageFoundations = new PermissionRecord { Name = "Admin area. Manage Foundations", SystemName = "ManageFoundations", Category = "Customers" };
        ...
        public static readonly PermissionRecord ManageNotification = new PermissionRecord { Name = "Admin area. Manage Notification", SystemName = "ManageNotification", Category = "Promo" };
