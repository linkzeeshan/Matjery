...
namespace Nop.Services.Messages
{
    ...
    public partial interface IWorkflowMessageService
    {
        ...
        int SendContactUsNotification(int languageId, string subject, string email, string body);
        ...
        IList<int> SendCustAccountDeletedNotification(Customer customer, int languageId);
        IList<int> SendSellerAccountDeletedNotification(Vendor vendor, int languageId);
        IList<int> SendCustomerAccountDeleteNotification(Customer customer, int languageId, string subject, string email, string body, string reason = null);
        IList<int> SendVendorAccountDeleteNotification(Vendor vendor, int languageId, string subject, string email, string body, string reason = null);
        #endregion
        ...
        IList<int> SendOrderProcessesCustomerNotification(Order order, int languageId);
        /// <summary>
        ...
        /// <summary>
        /// Sends 'Vendor Account Approved' message to a store owner
        /// </summary>
        /// <param name="vendor">Vendor</param>
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendVendorAccountApprovedNotification(Vendor vendor, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendVendorproductpublishedeNotification(Vendor vendor, Product product, int languageId);
        ...
        /// <param name="body">Email body</param>
        /// <returns>Queued email identifier</returns>
        IList<int> SendContactVendorMessage(Vendor vendor, int languageId, string senderEmail, string senderName, string inquiry, string subject, string body);
        ...
        #region BlackPoint admin notify
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        int SendBlackPointNotificationToAdmin(BlackPoint blackPoint, int languageId);
        #endregion
        #region BlackPoint admin notify
        /// <summary>
        /// 
        ...
        /// <param name="languageId"></param>
        /// <returns></returns>
        int SendBlackPointBlockedNotificationToVendor(Vendor vendor, int languageId, bool addNotification = false,Order order=null);
        ...
        /// <param name="languageId"></param>
        /// <returns></returns>
        int SendBlackPointBlockedNotificationToCustomer(Customer customer, int languageId, bool addNotification = false,Order order=null);
        ...
        /// <param name="languageId"></param>
        /// <returns></returns>
        int SendBlackPointApprovedNotificationToCustomerOrVendor(string email, string userName, int languageId);
        #endregion
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendApplyFoundationSubmitNotificationMessage(Foundation foundation, int languageId);
        ...
        /// <returns></returns>
        MessageTemplate GetNotificationEmailTemplate(int storeId, int languageId);
        #endregion
        ...
        /// <param name="languageId"></param>
        /// <returns></returns>
        int SendTradeLicenseExpiryNotificationToVendor(Vendor vendor, int languageId, bool addNotification = false,string ExpiryDate="",string Template="");
