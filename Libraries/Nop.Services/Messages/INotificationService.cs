...
namespace Nop.Services.Messages
{
    ...
    public partial interface INotificationService
    {
        ...
        void Notification(NotifyType type, string message, bool encode = true, string name=null);
        ...
        /// <param name="message">Message</param>
        /// <param name="encode">A value indicating whether the message should not be encoded</param>
        void SuccessNotification(string message, bool encode = true, string name=null);
        ...
        /// <param name="message">Message</param>
        /// <param name="encode">A value indicating whether the message should not be encoded</param>
        void WarningNotification(string message, bool encode = true, string name=null);
