...
namespace Nop.Services.Messages
{
    ...
    {
        void AddContactUsTokens(IList<Token> tokens, string subject, string email, string body);

        void AddVendorLicenseTokens(IList<Token> tokens, Vendor vendor, string ExpiryDate, int langaugeId);

        void AddBlackPointTokens(IList<Token> tokens, BlackPoint blackPoint);

        void AddFoundationTokens(IList<Token> tokens, Foundation foundation);

        void AddCampaignTokens(IList<Token> tokens, Campaign campaign, int langaugeId);
        /// <summary>
        /// Add store tokens
        /// </summary>
        ...
        void AddVendorOrCustomerTokens(IList<Token> tokens, Vendor vendor, Customer customer);
        ...
        /// <param name="tokens">List of already added tokens</param>
        /// <param name="customerId">Customer identifier</param>
        /// <param name="reason">Customer identifier</param>
        void AddCustomerTokens(IList<Token> tokens, int customerId, string reason = null);
