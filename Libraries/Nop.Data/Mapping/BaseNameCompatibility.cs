...
namespace Nop.Data.Mapping
{
    ...
    public partial class BaseNameCompatibility : INameCompatibility
    {
        public Dictionary<Type, string> TableNames => new Dictionary<Type, string>
        {
            ...
            { typeof(ProductCampaign), "Product_Campaign_Mapping" },
            ...
            { typeof(VendorFollower), "NopWarehouse_VendorFollower" },
             { typeof(VendorReview), "NopWarehouse_VendorReview" },
            ...
            { typeof(CustomerTranslationMapping), "Customer_Translation_Mapping" }
        };
