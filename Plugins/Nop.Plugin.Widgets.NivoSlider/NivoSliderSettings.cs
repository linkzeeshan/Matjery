...
namespace Nop.Plugin.Widgets.NivoSlider
{
    public class NivoSliderSettings : ISettings
    {
        ...
        public int MobilePicture1Id { get; internal set; }
        public int MobilePicture2Id { get; internal set; }
        public int MobilePicture3Id { get; internal set; }
        public int MobilePicture4Id { get; internal set; }
        public int MobilePicture5Id { get; internal set; }
    }
}