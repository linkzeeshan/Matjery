    ...
    public class WidgetsNivoSliderController : BasePluginController
    {
        ...
        public IActionResult Configure()
        {
            ...
            if (storeScope > 0)
            {
                ...
                model.MobilePicture1Id_OverrideForStore = _settingService.SettingExists(nivoSliderSettings, x => x.MobilePicture1Id, storeScope);
                ...
                model.MobilePicture2Id_OverrideForStore = _settingService.SettingExists(nivoSliderSettings, x => x.MobilePicture2Id, storeScope);
                ...
                model.MobilePicture3Id_OverrideForStore = _settingService.SettingExists(nivoSliderSettings, x => x.MobilePicture3Id, storeScope);
                ...
                model.MobilePicture4Id_OverrideForStore = _settingService.SettingExists(nivoSliderSettings, x => x.MobilePicture4Id, storeScope);
                ...
                model.MobilePicture5Id_OverrideForStore = _settingService.SettingExists(nivoSliderSettings, x => x.MobilePicture5Id, storeScope);
        ...
        public IActionResult Configure(ConfigurationModel model)
        {
            ...
            _settingService.SaveSettingOverridablePerStore(nivoSliderSettings, x => x.MobilePicture1Id, model.Picture1Id_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(nivoSliderSettings, x => x.MobilePicture2Id, model.Picture2Id_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(nivoSliderSettings, x => x.MobilePicture3Id, model.Picture3Id_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(nivoSliderSettings, x => x.MobilePicture4Id, model.Picture4Id_OverrideForStore, storeScope, false);
            ...
            _settingService.SaveSettingOverridablePerStore(nivoSliderSettings, x => x.MobilePicture5Id, model.Picture5Id_OverrideForStore, storeScope, false);
