...
namespace Nop.Plugin.NopWarehouse.VendorReview.Components
{
    [ViewComponent(Name = VendorReviewDefaults.TRACKING_VIEW_COMPONENT_NAME)]
    public class WidgetsVendorReviewViewComponent: NopViewComponent
    {
        #region Fields
        ...
        #endregion
        #region ctr
        public WidgetsVendorReviewViewComponent(IVendorService vendorService,
        ...
        #endregion
        public IViewComponentResult Invoke(int vendorId,bool isEmptyModel=true,string widgetZone="", object additionalData=null)
        {
            VendorReviewsModel model = new VendorReviewsModel();
